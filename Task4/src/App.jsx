...
// Create a registration form with fields: Name, Email, Password, Gender, Skills (checkboxes). Display submitted data below.
        ...
        <div>
          ...
          <div className="flex gap-4">
            <label className="flex items-center gap-2">
              <input type="radio" name="gender" value="male" checked={input.gender === "male"} onChange={handleRadio} />
              Male
            </label>
            <label className="flex items-center gap-2">
              <input type="radio" name="gender" value="female" checked={input.gender === "female"} onChange={handleRadio} />
              Female
            </label>
            <label className="flex items-center gap-2">
              <input type="radio" name="gender" value="other" checked={input.gender === "other"} onChange={handleRadio} />
              Other
            </label>
          </div>
        </div>
